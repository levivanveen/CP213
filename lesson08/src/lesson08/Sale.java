...
public class Sale {
	...
	/*
	 * Returns true if the names are the same and the bill for the calling object is
	 * equal to the bill for otherSale; otherwise returns false. Also returns false
