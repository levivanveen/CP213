...
public class GeneralizedSelectionSort {
	/**
	 * Precondition: numberUsed <= a.length; The first numberUsed indexed variables
	 * have values. Action: Sorts a so that a[0, a[1], ... , a[numberUsed - 1] are
	 * in increasing order by the compareTo method.
	 */
