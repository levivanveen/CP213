 ...
 */
public class LongActionInMainThread extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		LongActionInMainThread gui = new LongActionInMainThread();
		gui.setVisible(true);
	}

	public LongActionInMainThread() {
		setSize(WIDTH, HEIGHT);
		setTitle("Long running taks in Main thread");
