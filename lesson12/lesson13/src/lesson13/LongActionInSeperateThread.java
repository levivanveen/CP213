...
public class LongActionInSeperateThread extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		LongActionInSeperateThread gui = new LongActionInSeperateThread();
		gui.setVisible(true);
	}

	public LongActionInSeperateThread() {
		setSize(WIDTH, HEIGHT);
		setTitle("Threaded class is used");
