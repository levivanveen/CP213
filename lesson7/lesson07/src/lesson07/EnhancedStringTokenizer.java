...
public class EnhancedStringTokenizer extends StringTokenizer {
	...
	/**
	 * Returns the same value as the same method in the
	 *  StringTokenizer class,
	 *  but	it also stores data for the method 
	 *  tokensSoFar to use.
	 */
	 ...
	 * Returns the same value as the same method in the 
	 * StringTokenizer class,
	 * changes the delimiter set in the same way as does the 
	 * same method in the
	 * StringTokenizer class, but it also stores data for the 
	 * method tokensSoFar to
	 * use.
	 */
